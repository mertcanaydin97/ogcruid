...
<div class="row row-dd row-dd-relationship">
    <div class="col-xs-2">
        <h4><i class="cruid-heart"></i><strong>{{ $relationship->getTranslatedAttribute('display_name') }}</strong></h4>
        <div class="handler cruid-handle"></div>
        <strong>{{ __('cruid::database.type') }}:</strong> <span>{{ __('cruid::database.relationship.relationship') }}</span><br/>
    ...
    <div class="col-xs-2">
        ...
        <label for="field_browse_{{ $relationship['field'] }}"> {{ __('cruid::database.relationship.browse') }}</label><br>
        ...
        <label for="field_read_{{ $relationship['field'] }}"> {{ __('cruid::database.relationship.read') }}</label><br>
        ...
        <label for="field_edit_{{ $relationship['field'] }}"> {{ __('cruid::database.relationship.edit') }}</label><br>
        ...
        <label for="field_add_{{ $relationship['field'] }}"> {{ __('cruid::database.relationship.add') }}</label><br>
        ...
        <label for="field_delete_{{ $relationship['field'] }}"> {{ __('cruid::database.relationship.delete') }}</label><br>
    </div>
    <div class="col-xs-2">
        <p>{{ __('cruid::database.relationship.relationship') }}</p>
    </div>
    <div class="col-xs-2">
    ...
    <div class="col-xs-4">
        <div class="cruid-relationship-details-btn">
            <i class="cruid-angle-down"></i><i class="cruid-angle-up"></i>
            <span class="open_text">{{ __('cruid::database.relationship.open') }}</span>
            <span class="close_text">{{ __('cruid::database.relationship.close') }}</span>
            {{ __('cruid::database.relationship.relationship_details') }}
        </div>
    </div>
    <div class="col-md-12 cruid-relationship-details">
        <a href="{{ route('cruid.bread.delete_relationship', $relationship['id']) }}" class="delete_relationship"><i class="cruid-trash"></i> {{ __('cruid::database.relationship.delete') }}</a>
        <div class="relationship_details_content">
            ...
            <span><input type="text" class="form-control" name="relationship_model_{{ $relationship['field'] }}" placeholder="{{ __('cruid::database.relationship.namespace') }}" value="{{ $relationshipDetails->model ?? '' }}"></span>
        </div>
        ...
        <div class="relationship_details_content margin_top">
            <label>{{ __('cruid::database.relationship.display_the') }} <span class="label_table_name"></span></label>
            ...
            <div class="belongsToShow belongsToManyShow relationship_details_content" style="flex:1">
                <label class="relationship_key">{{ __('cruid::database.relationship.store_the') }} <span class="label_table_name"></span></label>
            ...
            <div class="hasOneShow hasManyShow relationship_details_content" style="flex:1">
                <label class="relationship_key">{{ __('cruid::database.relationship.store_the') }}
            ...
            @isset($relationshipDetails->taggable)
                <label class="relationship_taggable">
                    {{__('cruid::database.relationship.allow_tagging')}}
                </label>
                <span class="relationship_taggable">
                    <input type="checkbox" name="relationship_taggable_{{ $relationship['field'] }}" class="toggleswitch" data-on="{{ __('cruid::generic.yes') }}" data-off="{{ __('cruid::generic.no') }}" {{$relationshipDetails->taggable == 'on' ? 'checked' : ''}}>
                </span>
            @endisset
        </div>
        <div class="relationship_details_content margin_top">
            <div class="col-xs-12" style="margin: 0px !important; padding: 0px !important;">
                ...
                <label>{{ __('cruid::database.relationship.relationship_details') }}</label>
