...
return [
    'welcome'                => 'Bem-vindo à Bússola do Cruid. Todo bom app precisa de uma bússola para mostrar a direção correta.
    Nessa seção você encontrará muitos recursos e tarefas administativas que o guiará na construção de sua aplicação.',
    'links'         => [
        'title'                 => 'Links',
        'documentation'         => 'Documentação',
        'cruid_homepage'      => 'Página Inicial do Cruid',
    ],
    'commands'      => [
        'title'                 => 'Comandos',
        'text'                  => 'Rodar Comandos Artisan a partir do Cruid.',
    ...
    'resources'     => [
        'title'                 => 'Recursos',
        'text'                  => 'Os Recursos Cruid ajudará você encontrar as coisas mais rápido.',
    ...
    'fonts'         => [
        'title'                 => 'Fontes',
        'font_class'            => 'Mapa de Classe de Fonte Cruid',
        'font_character'        => 'Mapa de Caracteres de Fonte Cruid',
    ],
];
