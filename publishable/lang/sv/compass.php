...
return [
    'welcome'           => 'Välkommen till Cruid Compass. Alla bra appar behöver in kompass som visar riktningen.
    I denna avdelning hittar du resurser som hjälper dig att bygga din applikation',
    'links' => [
        'title'                 => 'Länkar',
        'documentation'         => 'Dokumentation',
        'cruid_homepage'      => 'Cruid Hemsida',
    ],
    'commands' => [
        'title'                 => 'Kommandon',
        'text'                  => 'Kör Artisan Kommandon från Cruid.',
    ...
    'resources' => [
        'title'                 => 'Resurser',
        'text'                  => 'Cruid resurser som hjälper dig hitta snabbare.',
    ],
    'logs' => [
        'title'                 => 'Loggar',
    ...
    'fonts' => [
        'title'                 => 'Typsnitt',
        'font_class'            => 'Cruid Typsnitt Klasser',
        'font_character'        => 'Cruid Typsnitt Tecken',
    ],
];
