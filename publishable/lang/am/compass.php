...
return [
    'welcome'                => 'Բարի գալուստ Cruid կողմնացույց. Յուրաքանչյուր լավ հավելվածի պետք է կողմնացույց, որը կմատնանշի նրանց ճիշտ ուղղությամբ։
    ...
    'links'         => [
        ...
        'cruid_homepage'      => 'Cruid Գլխավոր էջ',
    ],
    'commands'      => [
        'title'                 => 'Հրամաններ',
        'text'                  => 'Աշխատեցնել Artisan հրամանները Cruid-ից։',
    ...
    'resources'     => [
        'title'                 => 'Ռեսուրսներ',
        'text'                  => 'Cruid-ի ռեսուրսները օգնում են Ձեզ գտնել ավելի արագ',
    ...
    'fonts'         => [
        'title'                 => 'Տառատեսակներ',
        'font_class'            => 'Cruid-ի տառատեսակների դասերի քարտեզագրում',
        'font_character'        => 'Cruid-ի տառատեսակների նիշերի քարտեզագրում',
    ],
];
