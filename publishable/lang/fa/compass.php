...
return [
    'welcome'                => '
    به قطب نمای cruid خوش آمدید! هر اپلیکیشن خوب باید یک قطب نما داشته باشد که کاربران را به جهات صحیح هدایت کند!.
    ...
    'links'         => [
        ...
        'cruid_homepage'      => 'صفحه اصلی cruid',
    ],
    'commands'      => [
        'title'                 => 'دستورات',
        'text'                  => 'اجرای دستورات Artisan از cruid',
    ...
    'resources'     => [
        'title'                 => 'منابع',
        'text'                  => 'منابع Cruid برای کمک به شما جهت یافتن سریع تر آنچه به دنبالش هستید',
    ...
    'fonts'         => [
        'title'                 => 'فونت ها',
        'font_class'            => 'نقشه کلاس های فونت Cruid',
        'font_character'        => 'نقشه کاراکترهای فونت Cruid',
    ],
];
