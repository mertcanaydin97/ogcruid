...
return [
    'welcome'                => 'Καλωσήρθατε στην Πυξίδα Cruid. Κάθε καλή εφαρμογή χρειάζεται μία πυξίδα για να σας καθοδηγήσει προς τη σωστή κατεύθυνση. Σε αυτό τον τομέα θα βρείτε πολλές πηγές και ενέργειες διαχείρισης που θα σας βοηθήσουν όσο χτίζετε την εφαρμογή σας.',
    'links'                  => [
        'title'                 => 'Σύνδεσμοι',
        'documentation'         => 'Τεκμηρίωση',
        'cruid_homepage'      => 'Αρχική σελίδα Cruid',
    ],
    'commands'      => [
        'title'                 => 'Εντολές',
        'text'                  => 'Τρέξτε Artisan εντολές μέσα από το Cruid.',
    ...
    'resources'     => [
        'title'                 => 'Πηγές',
        'text'                  => 'Πηγές για το Cruid ώστε να βρείτε ό,τι ψάχνετε γρηγορότερα.',
