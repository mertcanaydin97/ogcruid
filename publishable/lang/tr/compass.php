...
return [
    'welcome'                => 'Cruid Pusula\'ya hoşgeldiniz. Her iyi uygulama doğru istikamette ilerlemek için bir pusulaya ihtiyaç duyar.
    Bu bölümde uygulamanızı geliştirirken size rehberlik edecek bir çok kaynak ve yönetimsel görev bulacaksınız.',
    'links'         => [
        'title'                 => 'Bağlantılar',
        'documentation'         => 'Dokümantasyon',
        'cruid_homepage'      => 'Cruid Anasayfa',
    ],
    'commands'      => [
        'title'                 => 'Komutlar',
        'text'                  => 'Artisan Komutlarını Cruid\'dan Çalıştır.',
    ...
    'resources'     => [
        'title'                 => 'Kaynaklar',
        'text'                  => 'Aradığınız şeyleri bulmanızı kolaylaştıracak Cruid kaynakları.',
    ...
    'fonts'         => [
        'title'                 => 'İkonlar',
        'font_class'            => 'Cruid İkon Class Eşleştirmesi',
        'font_character'        => 'Cruid İkon Karakter Eşleştirmesi',
    ],
];
