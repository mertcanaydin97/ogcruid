...
return [
    'welcome'                => 'Добре дошли във Cruid Compass. Всяка хубава апликация има нужда от компас да насочва потребителите към правилната посока.

    В тази секция ще намерите много ресурси и административки задачи, които ще ви помогнат да създадете вашата апликация.',
    'links'         => [
        'title'                 => 'Линкове',
        'documentation'         => 'Документация',
        'cruid_homepage'      => 'Начална страница на Cruid',
    ],
    'commands'      => [
        'title'                 => 'Команди',
        'text'                  => 'Run Artisan команди от Cruid.',
    ...
    'resources'     => [
        'title'                 => 'Ресурси',
        'text'                  => 'Cruid ресурси, които ще ви помогнат да намерите всичко по-бързо.',
