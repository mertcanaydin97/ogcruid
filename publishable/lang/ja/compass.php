...
return [
    'welcome'                => 'Cruidコンパスへようこそ。 すべての素晴らしいアプリケーションには正しい方向を示すコンパスが必要です。
        このセクションでは、アプリケーションを構築する際に役立つ多くのリソースと管理タスクを紹介します。',
    'links'         => [
        'title'                 => 'リンク',
        'documentation'         => 'ドキュメント(英語サイト)',
        'cruid_homepage'      => 'Cruid ホームページ (英語サイト)',
    ],
    'commands'      => [
        'title'                 => 'コマンド',
        'text'                  => 'CruidからArtisanコマンドを実行します。',
        'clear_output'          => '出力をクリア',
    ...
    'resources'     => [
        'title'                 => 'リソース',
        'text'                  => 'Cruidリソースはより素早く探しものをする手助けとなります。',
    ...
    'fonts'         => [
        'title'                 => 'フォント',
        'font_class'            => 'Cruid Fonts Class マッピング',
        'font_character'        => 'Cruid Fonts Character マッピング',
    ],
];
