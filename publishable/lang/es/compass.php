...
return [
    'welcome'                => 'Bienvenido(a) a Cruid Compass. Toda buena aplicación necesita una brújula que guíe en la dirección correcta.
    En esta sección encontrará recursos y tareas administrativas para ayudarle con la construcción de su aplicación.',
    'links'         => [
        'title'                 => 'Enlaces',
        'documentation'         => 'Documentación',
        'cruid_homepage'      => 'Página de inicio de Cruid',
    ],
    'commands'      => [
        'title'                 => 'Comandos',
        'text'                  => 'Ejecute comandos Artisan desde Cruid.',
    ...
    'resources'     => [
        'title'                 => 'Recursos',
        'text'                  => 'Recursos sobre Cruid a la mano.',
    ],
    'logs'          => [
        'title'                 => 'Registros',
    ...
    'fonts'         => [
        'title'                 => 'Fuentes',
        'font_class'            => 'Mapa de clases de Cruid Fonts',
        'font_character'        => 'Mapa de caracteres de Cruid Fonts',
    ],
];
