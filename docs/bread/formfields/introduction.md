...
Formfields are the hearth of Cruids BREAD-system.  
...
All types can include a description in order to help your future self or other users using your Cruid admin panel to understand exactly what a specific BREAD input field is for, this can be defined in the `Optional Details` JSON input field:
