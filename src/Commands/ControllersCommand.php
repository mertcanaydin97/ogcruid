...
class ControllersCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'cruid:controllers';
     ...
     * @var string
     */
    protected $description = 'Publish all the controllers from Cruid.';
    ...
    {
        $stub = $this->getStub();
        $files = $this->filesystem->files(base_path('vendor/tcg/cruid/src/Http/Controllers'));
        $namespace = config('cruid.controllers.namespace', 'Og\\Cruid\\Http\\Controllers');
        ...
        $this->info('Published Cruid controllers!');
    }
    ...
    {
        return $this->filesystem->get(base_path('/vendor/tcg/cruid/stubs/'.$this->stub));
    }
    ...
    protected function generateContent($stub, $class)
    {
        ...
        $content = str_replace(
            'FullBaseDummyClass',
            'Og\\Cruid\\Http\\Controllers\\'.$class,
            $content
        );
