...
trait CruidUser
{
    ...
    {
        return $this->belongsTo(Cruid::modelClass('Role'));
    }
    ...
    {
        return $this->belongsToMany(Cruid::modelClass('Role'), 'user_roles', 'user_id', 'role_id');
    }
    ...
    {
        $role = Cruid::model('Role')->where('name', '=', $name)->first();
